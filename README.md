...
<img src="./assets/github-banner.jpg" alt="FetchDesk - High-Performance Terminal-Based Multi-Connection Download Manager" width="100%">
...
├── assets/
│   └── github-banner.jpg # Premium repository banner image
├── src/
